...
export function RadarMap({ lat = 39.9208, lon = 32.8541, zoom = 6 }: RadarMapProps) {
  ...
  // For simplicity, we'll use a general map. A more advanced version could set lat/lon/zoom.
  ...
  return (
    <Card className="shadow-lg rounded-xl">
      <CardHeader>
        <CardTitle>Canlı Bulut & Yağış Takibi</CardTitle>
      </CardHeader>
      <CardContent>
        <iframe
          src={mapUrl}
